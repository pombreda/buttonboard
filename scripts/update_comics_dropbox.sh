...
find /Users/username/Dropbox/comics -mtime +$ARCHIVE_TIME -name \*.cb[zr] -exec rm {} \;

#Copy in files newer than Y days
find /data/torrents/torrents/trans -mtime -$ARCHIVE_TIME -name \*.cb[zr] -exec cp -n -a {} /Users/username/Dropbox/comics \;
